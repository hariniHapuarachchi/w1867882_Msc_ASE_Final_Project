...
namespace w1867882_Harini_Hapuarachchi_Land_Evaluation.Migrations
{
    ...
    [Migration("20230516184154_CreateLandEvaluationDb")]
    partial class CreateLandEvaluationDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("w1867882_Harini_Hapuarachchi_Land_Evaluation.Models.CoconutLand", b =>
                {
                    b.Property<int>("CoconutId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CoconutId"));
                    ...
                    b.Property<float>("MeanAnualTemp")
                        .HasColumnType("real");

                    b.Property<float>("MinimumHumidity")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("TotalSunshine")
                        .HasColumnType("real");

                    b.Property<float>("WaterDepth")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("w1867882_Harini_Hapuarachchi_Land_Evaluation.Models.RubberLand", b =>
                {
                    ...
                    b.ToTable("RubberLands");
                });

            modelBuilder.Entity("w1867882_Harini_Hapuarachchi_Land_Evaluation.Models.TeaLand", b =>
                {
                    b.Property<int>("TeaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TeaId"));
            ...
            modelBuilder.Entity("w1867882_Harini_Hapuarachchi_Land_Evaluation.Models.CoconutLand", b =>
                {
                    b.HasOne("w1867882_Harini_Hapuarachchi_Land_Evaluation.Models.Land", "Lands")
                        .WithMany("CoconutLands")
            ...
            modelBuilder.Entity("w1867882_Harini_Hapuarachchi_Land_Evaluation.Models.Land", b =>
                {
                    b.Navigation("CoconutLands");

                    b.Navigation("Evaluations");

                    b.Navigation("RubberLands");

                    b.Navigation("TeaLands");
                });
